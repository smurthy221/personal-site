...
function Header(path){
    const [header, showHeader] = useState(path.page !== '/');
    ...
    return(
        <div className = {header ? 'header' : 'header-transparent'}>
            <Icon onPage={(path.page === '/')} page_title={'Sid Murthy'} page='' show={header ? 'header-title' : 'header-title-transparent'}/>
            ...
            <Icon onPage={(path.page === '/about-sid')} page_title={'About Sid'} page='about-sid'/>
            <Icon onPage={(path.page === '/experience')} page_title={'Experience/Skills'} page='experience'/>
        </div>
    )
};
